...
> Version 2.1 · source digest `61fe3a59d4b5` · 2026-07-30
> Source of truth: <https://github.com/AdamPippert/AgentStyleGuide>
...
[`STANDARD.md`](https://github.com/AdamPippert/AgentStyleGuide/src/branch/main/STANDARD.md).

## Mechanical — run the linter

The linter lives in the repository, not on this machine:
`https://github.com/AdamPippert/AgentStyleGuide` → `tools/lint.py`
